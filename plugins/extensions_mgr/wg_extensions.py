...
from .util_ext import (
    scan_extensions, ExtensionsData, ProfilesData,
    ExtensionStatusRole,
    ExtensionIdRole,
)
...
class BaseExtensionsListModel(QtCore.QAbstractListModel):
    ...
    def __init__(self, parent=None):
        ...
        none_img = Path(Path(__file__).parent, "images", "none_128.png")
        self.blank_icon = QtGui.QIcon(str(none_img))
...
class WgExtensions(QtWidgets.QWidget):
    ...
    def on_cbx_compat_clicked(self):
        self.update_model(self.browser)
    ...
    def filters_clicked(self, safe_mark: bool | None, checked: bool):
        model = self.ext_list_models[self.browser]
